...
OverviewTab = (function(_super) {
  ...
  OverviewTab.prototype.render = function() {
    var context, ddv, dfv, displaced_dive_value, displaced_fishing_value, isCollection, meets_zone_thresh, min_dim, min_dim_name, min_dim_size, size, zone_data, zone_sizes, zone_tot;
  ...
  OverviewTab.prototype.cleanupDataAndSetThresholds = function(data) {
    var d, zone_parts, _i, _len, _results;
    _results = [];
    for (_i = 0, _len = data.length; _i < _len; _i++) {
      d = data[_i];
      ...
      _results.push(console.log("meets: ", d.MEETS_THRESH));
    }
    return _results;
  };
